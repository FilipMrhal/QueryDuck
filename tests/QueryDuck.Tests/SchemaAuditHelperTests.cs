...
public sealed class SchemaAuditHelperTests
{
    ...
    {
        var mismatch = new NullabilityMismatch("Customer", "Region", "Region", false, true, "Mismatch");
        var typeMismatch = new TypeMismatch("Customer", "Code", "Code", "string", "NUMBER", "Type mismatch");
