...
public static partial class QueryHistoricalStatsSqlMatcher
{
    ...
    public static bool IsLikelyMatch(string capturedSql, string historicalQueryText)
    {
        var left = NormalizeForMatch(capturedSql);
        var right = NormalizeForMatch(historicalQueryText);
